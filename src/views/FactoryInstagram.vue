  ...
  <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
    ...
    <div class="md:flex md:items-center md:justify-between py-4">
        ...
        <div class="mt-4 flex md:mt-0 md:ml-4">
          <a href="https://api.instagram.com/oauth/authorize?client_id=298290545660406&redirect_uri=https://api.simping.org/instagram-redirect&scope=user_profile,user_media&response_type=code">
